...
#ifdef USE_SCRYPT
	cl_mem CLbuffer0;
	cl_mem padbuffer8[5];  // Multiple buffers (up to 5) for better memory utilization
	size_t num_padbuffers;  // Number of padbuffer8 buffers (1-5)
	size_t groups_per_buffer[5];  // Number of groups per buffer
